...
public class NMHInfiniteModeMng : MonoBehaviour
{
    ...
    void SpawnJunior(int _nStageType)
    {
        ...
        {
            case (int)StageType.TRIANGLE:
                GameObject TriangleJuniorCloneObj = Instantiate(TriangleJuniorObjArr[0], JuniorParent.transform);
                break;
            case (int)StageType.SQUARE:
                GameObject SquareJuniorCloneObj = Instantiate(SquareJuniorObjArr[0], JuniorParent.transform);
                break;
            case (int)StageType.RHOMBUS:
    ...
    void SpawnBoss(int _nStageType)
    {
        ...
        {
            case (int)StageType.TRIANGLE:
                GameObject TriangleBossCloneObj = Instantiate(TriangleBoss, BossParent.transform);
                break;
            case (int)StageType.SQUARE:
                GameObject SquareBossCloneObj = Instantiate(SquareBoss, BossParent.transform);
                break;
            case (int)StageType.RHOMBUS:
        ...
        BossHPBar.GetComponent<NMHBossHPBar>().SetHPBar(_nStageType);
